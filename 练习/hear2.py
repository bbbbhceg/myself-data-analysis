...
CANVAS_WIDTH = 640  # 在这里改画布的宽，最好和高成比例放大
CANVAS_HEIGHT = 480  # 在这里改画布的高，最好和宽成比例放大
CANVAS_CENTER_X = CANVAS_WIDTH / 2  # 画布中心的X轴坐标
CANVAS_CENTER_Y = CANVAS_HEIGHT / 2  # 画布中心的Y轴坐标
IMAGE_ENLARGE = 11  # 在这里改放大比例，画布放大后，心太小？把这个改大点
...
def heart_curve(p):
    ...
    :return: 正弦 + 贝塞尔
    """
    return curve(p, (0.69, 0.75, 0.2, 0.95))  # 在这里改爱心的贝塞尔曲线参数
...
def heart_halo_curve(p):
    ...
    :return: 正弦 + 贝塞尔
    """
    return curve(p, (0.75, 0.49, 0.46, 0.97))  # 在这里改光环的贝塞尔曲线参数
...
class Heart:
    ...
    def __init__(self, generate_frame=20):
        ...
        self.build(2000)  # 在这里改初始的点数，太大可能运行缓慢
    ...
    if __name__ == '__main__':
        ...
        canvas_dict = {}
        heart = Heart(40)  # 总帧数，帧数越大，花样越多，但更占内存
        draw(root, canvas_dict, heart)  # 开始绘制动画
        end_time = time.time()
        print(f'爱心魔法耗时 {end_time - start_time:.2f} 秒完成 ~')
        root.mainloop()